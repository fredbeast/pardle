this.wordle = this.wordle || {}, this.wordle.bundle = function (e) {
    ...
    z.innerHTML = "\n  <slot></slot>\n";
    var j = "parry-wordle-darkmode",
        S = "parry-wordle-cbmode",
        C = function (e) {
            r(t, e);
            var a = h(t);
    ...
    var Ga = new Date(2022, 2, 4, 0, 0, 0, 0);
    ...
    var Ya = "parry-wordle-statistics",
        Ua = "fail",
        Ja = {
            currentStreak: 0,
            maxStreak: 0,
    ...
    var Ka, Qa = "parry-wordle-refresh",
    ...
    var ss = "parry-wordle-statistics",
    ...
    var ls = "IN_PROGRESS",
        ds = "WIN",
        cs = "FAIL",
        us = ["Timmy Maj-ical", "Cross-Cultural Meanie", "Poppety-Poppety!", "Muppet.", "Timmy from Leeds", "Fox-am-phew!"],
        ms = function (e) {
            r(t, e);
            var a = h(t);
    ...
    var Fs = document.createElement("template"),
        ...
        Ys = [{
            ...
            url: "https://cooking.nytimes.com/?utm_source=wordle&utm_medium=referral&utm_campaign=wordle_nav",
